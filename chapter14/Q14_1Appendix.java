 ...
 *
//###### 出射さん解説 #####
【出射さん】 2020-09-02-1530
やっと説明出来る時間空きました。
Q14_1ですが、changeClothesがint型の引数を求めているのは解答にある通り超重要です。

解答の実行クラスにあるとおり、
インスタンスの生成やchangeClothesメソッドに定数を渡せるのがとても重要です。

多分もう時間経ったので済んでると思うのですが、
送ってもらったコードだと色を数字で渡すときに
いちいち1が白で2が黒で～みたいに確認しないといけないのですが、
定数を使うことで色の確認をしなくても済みます。

【大鹿】2020-09-02-1540
今日は9月開講のお仕事ですね。おつかれさまです。
ああ確かに色の管理は「色コード」とか使っていそうなので、
intで渡して必要に応じてStringにするほうが使いやすいですね

問題のほうを書き換えてしまいました(反省)

以前、ミニアプリ作ったとき、設計で苦労したので、設計のことを、
あれこれ言ってますが、お気を悪くされていたら、ごめんなさい
 * */
